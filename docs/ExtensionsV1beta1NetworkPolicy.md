...
**spec** | [***::models::ExtensionsV1beta1NetworkPolicySpec**](io.k8s.kubernetes.pkg.apis.extensions.v1beta1.NetworkPolicySpec.md) | Specification of the desired behavior for this NetworkPolicy. | [optional] [default to null]
