...
**spec** | [***::models::NetworkingV1NetworkPolicySpec**](io.k8s.kubernetes.pkg.apis.networking.v1.NetworkPolicySpec.md) | Specification of the desired behavior for this NetworkPolicy. | [optional] [default to null]
