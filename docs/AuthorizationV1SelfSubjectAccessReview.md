...
**spec** | [***::models::AuthorizationV1SelfSubjectAccessReviewSpec**](io.k8s.kubernetes.pkg.apis.authorization.v1.SelfSubjectAccessReviewSpec.md) | Spec holds information about the request being evaluated.  user and groups must be empty | [default to null]
