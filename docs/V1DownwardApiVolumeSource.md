...
**items** | [**Vec<::models::V1DownwardApiVolumeFile>**](io.k8s.kubernetes.pkg.api.v1.DownwardAPIVolumeFile.md) | Items is a list of downward API volume file | [optional] [default to null]
