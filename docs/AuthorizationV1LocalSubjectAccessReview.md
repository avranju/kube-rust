...
**spec** | [***::models::AuthorizationV1SubjectAccessReviewSpec**](io.k8s.kubernetes.pkg.apis.authorization.v1.SubjectAccessReviewSpec.md) | Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted. | [default to null]
