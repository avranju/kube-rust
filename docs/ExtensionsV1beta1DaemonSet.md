...
**spec** | [***::models::ExtensionsV1beta1DaemonSetSpec**](io.k8s.kubernetes.pkg.apis.extensions.v1beta1.DaemonSetSpec.md) | The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status | [optional] [default to null]
**status** | [***::models::ExtensionsV1beta1DaemonSetStatus**](io.k8s.kubernetes.pkg.apis.extensions.v1beta1.DaemonSetStatus.md) | The current status of this daemon set. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status | [optional] [default to null]
