...
**conditions** | [**Vec<::models::AppsV1beta1DeploymentCondition>**](io.k8s.kubernetes.pkg.apis.apps.v1beta1.DeploymentCondition.md) | Represents the latest available observations of a deployment&#39;s current state. | [optional] [default to null]
