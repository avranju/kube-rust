...
**conditions** | [**Vec<::models::V1ComponentCondition>**](io.k8s.kubernetes.pkg.api.v1.ComponentCondition.md) | List of component conditions observed | [optional] [default to null]
