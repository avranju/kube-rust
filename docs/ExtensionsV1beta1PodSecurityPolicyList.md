...
**items** | [**Vec<::models::ExtensionsV1beta1PodSecurityPolicy>**](io.k8s.kubernetes.pkg.apis.extensions.v1beta1.PodSecurityPolicy.md) | Items is a list of schema objects. | [default to null]
