...
**items** | [**Vec<::models::V1PersistentVolume>**](io.k8s.kubernetes.pkg.api.v1.PersistentVolume.md) | List of persistent volumes. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes | [default to null]
