...
**items** | [**Vec<::models::V1Secret>**](io.k8s.kubernetes.pkg.api.v1.Secret.md) | Items is a list of secret objects. More info: https://kubernetes.io/docs/concepts/configuration/secret | [default to null]
