...
**target** | [***::models::V1ObjectReference**](io.k8s.kubernetes.pkg.api.v1.ObjectReference.md) | The target object that you want to bind to the standard object. | [default to null]
