...
**items** | [**Vec<::models::V1ServiceAccount>**](io.k8s.kubernetes.pkg.api.v1.ServiceAccount.md) | List of ServiceAccounts. More info: https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/ | [default to null]
