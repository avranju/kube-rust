...
**data** | [***::models::RuntimeRawExtension**](io.k8s.apimachinery.pkg.runtime.RawExtension.md) | Data is the serialized representation of the state. | [optional] [default to null]
...
**revision** | **i64** | Revision indicates the revision of the state represented by Data. | [default to null]
