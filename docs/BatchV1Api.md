...
> ::models::BatchV1Job create_batch_v1_namespaced_job(ctx, namespace, body, optional)
...
[**::models::BatchV1Job**](io.k8s.kubernetes.pkg.apis.batch.v1.Job.md)
...
> ::models::MetaV1Status delete_batch_v1_collection_namespaced_job(ctx, namespace, optional)
...
> ::models::MetaV1Status delete_batch_v1_namespaced_job(ctx, name, namespace, body, optional)
...
> ::models::MetaV1ApiResourceList get_batch_v1_api_resources(ctx, )
...
> ::models::BatchV1JobList list_batch_v1_job_for_all_namespaces(ctx, optional)
...
[**::models::BatchV1JobList**](io.k8s.kubernetes.pkg.apis.batch.v1.JobList.md)
...
> ::models::BatchV1JobList list_batch_v1_namespaced_job(ctx, namespace, optional)
...
> ::models::BatchV1Job patch_batch_v1_namespaced_job(ctx, name, namespace, body, optional)
...
> ::models::BatchV1Job patch_batch_v1_namespaced_job_status(ctx, name, namespace, body, optional)
...
> ::models::BatchV1Job read_batch_v1_namespaced_job(ctx, name, namespace, optional)
...
> ::models::BatchV1Job read_batch_v1_namespaced_job_status(ctx, name, namespace, optional)
...
> ::models::BatchV1Job replace_batch_v1_namespaced_job(ctx, name, namespace, body, optional)
...
> ::models::BatchV1Job replace_batch_v1_namespaced_job_status(ctx, name, namespace, body, optional)
...
> ::models::MetaV1WatchEvent watch_batch_v1_job_list_for_all_namespaces(ctx, optional)
...
> ::models::MetaV1WatchEvent watch_batch_v1_namespaced_job(ctx, name, namespace, optional)
...
> ::models::MetaV1WatchEvent watch_batch_v1_namespaced_job_list(ctx, namespace, optional)
