...
**items** | [**Vec<::models::V1Pod>**](io.k8s.kubernetes.pkg.api.v1.Pod.md) | List of pods. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md | [default to null]
