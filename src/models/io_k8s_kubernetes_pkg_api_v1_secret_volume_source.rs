...
impl V1SecretVolumeSource {
  ...
  pub fn with_default_mode(mut self, default_mode: i32) -> V1SecretVolumeSource {
    self.default_mode = Some(default_mode);
    self
  }
  ...
  pub fn with_items(mut self, items: Vec<::models::V1KeyToPath>) -> V1SecretVolumeSource {
    self.items = Some(items);
    self
  }
  ...
  pub fn with_optional(mut self, optional: bool) -> V1SecretVolumeSource {
    self.optional = Some(optional);
    self
  }
  ...
  pub fn with_secret_name(mut self, secret_name: String) -> V1SecretVolumeSource {
    self.secret_name = Some(secret_name);
    self
  }
