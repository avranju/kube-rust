...
impl V1Probe {
  ...
  pub fn with_exec(mut self, exec: ::models::V1ExecAction) -> V1Probe {
    self.exec = Some(exec);
    self
  }
  ...
  pub fn with_failure_threshold(mut self, failure_threshold: i32) -> V1Probe {
    self.failure_threshold = Some(failure_threshold);
    self
  }
  ...
  pub fn with_http_get(mut self, http_get: ::models::V1HttpGetAction) -> V1Probe {
    self.http_get = Some(http_get);
    self
  }
  ...
  pub fn with_initial_delay_seconds(mut self, initial_delay_seconds: i32) -> V1Probe {
    self.initial_delay_seconds = Some(initial_delay_seconds);
    self
  }
  ...
  pub fn with_period_seconds(mut self, period_seconds: i32) -> V1Probe {
    self.period_seconds = Some(period_seconds);
    self
  }
  ...
  pub fn with_success_threshold(mut self, success_threshold: i32) -> V1Probe {
    self.success_threshold = Some(success_threshold);
    self
  }
  ...
  pub fn with_tcp_socket(mut self, tcp_socket: ::models::V1TcpSocketAction) -> V1Probe {
    self.tcp_socket = Some(tcp_socket);
    self
  }
  ...
  pub fn with_timeout_seconds(mut self, timeout_seconds: i32) -> V1Probe {
    self.timeout_seconds = Some(timeout_seconds);
    self
  }
