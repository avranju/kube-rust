...
pub struct ExtensionsV1beta1DeploymentSpec {
  ...
  rollback_to: Option<::models::ExtensionsV1beta1RollbackConfig>,
  /// Label selector for pods. Existing ReplicaSets whose pods are selected by this will be the ones affected by this deployment.
  #[serde(rename = "selector")]
  selector: Option<::models::MetaV1LabelSelector>,
  /// The deployment strategy to use to replace existing pods with new ones.
  #[serde(rename = "strategy")]
  strategy: Option<::models::ExtensionsV1beta1DeploymentStrategy>,
  /// Template describes the pods that will be created.
  #[serde(rename = "template")]
  template: ::models::V1PodTemplateSpec
}

impl ExtensionsV1beta1DeploymentSpec {
  /// DeploymentSpec is the specification of the desired behavior of the Deployment.
  pub fn new(template: ::models::V1PodTemplateSpec) -> ExtensionsV1beta1DeploymentSpec {
  ...
  pub fn with_min_ready_seconds(mut self, min_ready_seconds: i32) -> ExtensionsV1beta1DeploymentSpec {
    self.min_ready_seconds = Some(min_ready_seconds);
    self
  }
  ...
  pub fn with_paused(mut self, paused: bool) -> ExtensionsV1beta1DeploymentSpec {
    self.paused = Some(paused);
    self
  }
  ...
  pub fn with_progress_deadline_seconds(mut self, progress_deadline_seconds: i32) -> ExtensionsV1beta1DeploymentSpec {
    self.progress_deadline_seconds = Some(progress_deadline_seconds);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> ExtensionsV1beta1DeploymentSpec {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_revision_history_limit(mut self, revision_history_limit: i32) -> ExtensionsV1beta1DeploymentSpec {
    self.revision_history_limit = Some(revision_history_limit);
    self
  }
  ...
  pub fn with_rollback_to(mut self, rollback_to: ::models::ExtensionsV1beta1RollbackConfig) -> ExtensionsV1beta1DeploymentSpec {
    self.rollback_to = Some(rollback_to);
    self
  }

  pub fn rollback_to(&self) -> Option<&::models::ExtensionsV1beta1RollbackConfig> {
  ...
  pub fn with_selector(mut self, selector: ::models::MetaV1LabelSelector) -> ExtensionsV1beta1DeploymentSpec {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn set_strategy(&mut self, strategy: ::models::ExtensionsV1beta1DeploymentStrategy) {
    self.strategy = Some(strategy);
  }

  pub fn with_strategy(mut self, strategy: ::models::ExtensionsV1beta1DeploymentStrategy) -> ExtensionsV1beta1DeploymentSpec {
    self.strategy = Some(strategy);
    self
  }

  pub fn strategy(&self) -> Option<&::models::ExtensionsV1beta1DeploymentStrategy> {
  ...
  pub fn with_template(mut self, template: ::models::V1PodTemplateSpec) -> ExtensionsV1beta1DeploymentSpec {
    self.template = template;
    self
  }
