...
impl V1ScaleIoVolumeSource {
  ...
  pub fn new(gateway: String, secret_ref: ::models::V1LocalObjectReference, system: String) -> V1ScaleIoVolumeSource {
  ...
  pub fn with_fs_type(mut self, fs_type: String) -> V1ScaleIoVolumeSource {
    self.fs_type = Some(fs_type);
    self
  }
  ...
  pub fn with_gateway(mut self, gateway: String) -> V1ScaleIoVolumeSource {
    self.gateway = gateway;
    self
  }
  ...
  pub fn with_protection_domain(mut self, protection_domain: String) -> V1ScaleIoVolumeSource {
    self.protection_domain = Some(protection_domain);
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> V1ScaleIoVolumeSource {
    self.read_only = Some(read_only);
    self
  }
  ...
  pub fn with_secret_ref(mut self, secret_ref: ::models::V1LocalObjectReference) -> V1ScaleIoVolumeSource {
    self.secret_ref = secret_ref;
    self
  }

  pub fn secret_ref(&self) -> &::models::V1LocalObjectReference {
    &self.secret_ref
  }
  ...
  pub fn with_ssl_enabled(mut self, ssl_enabled: bool) -> V1ScaleIoVolumeSource {
    self.ssl_enabled = Some(ssl_enabled);
    self
  }
  ...
  pub fn with_storage_mode(mut self, storage_mode: String) -> V1ScaleIoVolumeSource {
    self.storage_mode = Some(storage_mode);
    self
  }
  ...
  pub fn with_storage_pool(mut self, storage_pool: String) -> V1ScaleIoVolumeSource {
    self.storage_pool = Some(storage_pool);
    self
  }
  ...
  pub fn with_system(mut self, system: String) -> V1ScaleIoVolumeSource {
    self.system = system;
    self
  }
  ...
  pub fn with_volume_name(mut self, volume_name: String) -> V1ScaleIoVolumeSource {
    self.volume_name = Some(volume_name);
    self
  }
