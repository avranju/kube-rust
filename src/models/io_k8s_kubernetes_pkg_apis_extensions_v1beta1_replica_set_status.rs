...
/// ExtensionsV1beta1ReplicaSetStatus : ReplicaSetStatus represents the current status of a ReplicaSet.
...
pub struct ExtensionsV1beta1ReplicaSetStatus {
  ...
  conditions: Option<Vec<::models::ExtensionsV1beta1ReplicaSetCondition>>,
...
impl ExtensionsV1beta1ReplicaSetStatus {
  /// ReplicaSetStatus represents the current status of a ReplicaSet.
  pub fn new(replicas: i32) -> ExtensionsV1beta1ReplicaSetStatus {
  ...
  pub fn with_available_replicas(mut self, available_replicas: i32) -> ExtensionsV1beta1ReplicaSetStatus {
    self.available_replicas = Some(available_replicas);
    self
  }
  ...
  pub fn set_conditions(&mut self, conditions: Vec<::models::ExtensionsV1beta1ReplicaSetCondition>) {
    self.conditions = Some(conditions);
  }

  pub fn with_conditions(mut self, conditions: Vec<::models::ExtensionsV1beta1ReplicaSetCondition>) -> ExtensionsV1beta1ReplicaSetStatus {
    self.conditions = Some(conditions);
    self
  }

  pub fn conditions(&self) -> Option<&Vec<::models::ExtensionsV1beta1ReplicaSetCondition>> {
  ...
  pub fn with_fully_labeled_replicas(mut self, fully_labeled_replicas: i32) -> ExtensionsV1beta1ReplicaSetStatus {
    self.fully_labeled_replicas = Some(fully_labeled_replicas);
    self
  }
  ...
  pub fn with_observed_generation(mut self, observed_generation: i64) -> ExtensionsV1beta1ReplicaSetStatus {
    self.observed_generation = Some(observed_generation);
    self
  }
  ...
  pub fn with_ready_replicas(mut self, ready_replicas: i32) -> ExtensionsV1beta1ReplicaSetStatus {
    self.ready_replicas = Some(ready_replicas);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> ExtensionsV1beta1ReplicaSetStatus {
    self.replicas = replicas;
    self
  }
