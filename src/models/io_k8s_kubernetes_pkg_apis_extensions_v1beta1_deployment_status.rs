...
pub struct ExtensionsV1beta1DeploymentStatus {
  ...
  conditions: Option<Vec<::models::ExtensionsV1beta1DeploymentCondition>>,
...
impl ExtensionsV1beta1DeploymentStatus {
  /// DeploymentStatus is the most recently observed status of the Deployment.
  pub fn new() -> ExtensionsV1beta1DeploymentStatus {
  ...
  pub fn with_available_replicas(mut self, available_replicas: i32) -> ExtensionsV1beta1DeploymentStatus {
    self.available_replicas = Some(available_replicas);
    self
  }
  ...
  pub fn with_collision_count(mut self, collision_count: i64) -> ExtensionsV1beta1DeploymentStatus {
    self.collision_count = Some(collision_count);
    self
  }
  ...
  pub fn set_conditions(&mut self, conditions: Vec<::models::ExtensionsV1beta1DeploymentCondition>) {
    self.conditions = Some(conditions);
  }

  pub fn with_conditions(mut self, conditions: Vec<::models::ExtensionsV1beta1DeploymentCondition>) -> ExtensionsV1beta1DeploymentStatus {
    self.conditions = Some(conditions);
    self
  }

  pub fn conditions(&self) -> Option<&Vec<::models::ExtensionsV1beta1DeploymentCondition>> {
  ...
  pub fn with_observed_generation(mut self, observed_generation: i64) -> ExtensionsV1beta1DeploymentStatus {
    self.observed_generation = Some(observed_generation);
    self
  }
  ...
  pub fn with_ready_replicas(mut self, ready_replicas: i32) -> ExtensionsV1beta1DeploymentStatus {
    self.ready_replicas = Some(ready_replicas);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> ExtensionsV1beta1DeploymentStatus {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_unavailable_replicas(mut self, unavailable_replicas: i32) -> ExtensionsV1beta1DeploymentStatus {
    self.unavailable_replicas = Some(unavailable_replicas);
    self
  }
  ...
  pub fn with_updated_replicas(mut self, updated_replicas: i32) -> ExtensionsV1beta1DeploymentStatus {
    self.updated_replicas = Some(updated_replicas);
    self
  }
