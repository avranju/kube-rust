...
/// AdmissionregistrationV1alpha1RuleWithOperations : RuleWithOperations is a tuple of Operations and Resources. It is recommended to make sure that all the tuple expansions are valid.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize)]
pub struct AdmissionregistrationV1alpha1RuleWithOperations {
...
impl AdmissionregistrationV1alpha1RuleWithOperations {
  /// RuleWithOperations is a tuple of Operations and Resources. It is recommended to make sure that all the tuple expansions are valid.
  pub fn new() -> AdmissionregistrationV1alpha1RuleWithOperations {
  ...
  pub fn with_api_groups(mut self, api_groups: Vec<String>) -> AdmissionregistrationV1alpha1RuleWithOperations {
    self.api_groups = Some(api_groups);
    self
  }
  ...
  pub fn with_api_versions(mut self, api_versions: Vec<String>) -> AdmissionregistrationV1alpha1RuleWithOperations {
    self.api_versions = Some(api_versions);
    self
  }
  ...
  pub fn with_operations(mut self, operations: Vec<String>) -> AdmissionregistrationV1alpha1RuleWithOperations {
    self.operations = Some(operations);
    self
  }
  ...
  pub fn with_resources(mut self, resources: Vec<String>) -> AdmissionregistrationV1alpha1RuleWithOperations {
    self.resources = Some(resources);
    self
  }
