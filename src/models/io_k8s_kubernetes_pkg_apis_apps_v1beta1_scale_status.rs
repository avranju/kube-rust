...
pub struct AppsV1beta1ScaleStatus {
...
impl AppsV1beta1ScaleStatus {
  /// ScaleStatus represents the current status of a scale subresource.
  pub fn new(replicas: i32) -> AppsV1beta1ScaleStatus {
  ...
  pub fn with_replicas(mut self, replicas: i32) -> AppsV1beta1ScaleStatus {
    self.replicas = replicas;
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::std::collections::HashMap<String, String>) -> AppsV1beta1ScaleStatus {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn with_target_selector(mut self, target_selector: String) -> AppsV1beta1ScaleStatus {
    self.target_selector = Some(target_selector);
    self
  }
