...
impl V1AwsElasticBlockStoreVolumeSource {
  ...
  pub fn with_fs_type(mut self, fs_type: String) -> V1AwsElasticBlockStoreVolumeSource {
    self.fs_type = Some(fs_type);
    self
  }
  ...
  pub fn with_partition(mut self, partition: i32) -> V1AwsElasticBlockStoreVolumeSource {
    self.partition = Some(partition);
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> V1AwsElasticBlockStoreVolumeSource {
    self.read_only = Some(read_only);
    self
  }
  ...
  pub fn with_volume_id(mut self, volume_id: String) -> V1AwsElasticBlockStoreVolumeSource {
    self.volume_id = volume_id;
    self
  }
