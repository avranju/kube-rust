...
/// MetaV1ObjectMeta : ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct MetaV1ObjectMeta {
  ...
  creation_timestamp: Option<::models::MetaV1Time>,
  ...
  deletion_timestamp: Option<::models::MetaV1Time>,
  ...
  initializers: Option<::models::MetaV1Initializers>,
  ...
  owner_references: Option<Vec<::models::MetaV1OwnerReference>>,
...
impl MetaV1ObjectMeta {
  /// ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.
  pub fn new() -> MetaV1ObjectMeta {
    MetaV1ObjectMeta {
      annotations: None,
      cluster_name: None,
  ...
  pub fn with_annotations(mut self, annotations: ::std::collections::HashMap<String, String>) -> MetaV1ObjectMeta {
    self.annotations = Some(annotations);
    self
  }
  ...
  pub fn with_cluster_name(mut self, cluster_name: String) -> MetaV1ObjectMeta {
    self.cluster_name = Some(cluster_name);
    self
  }
  ...
  pub fn set_creation_timestamp(&mut self, creation_timestamp: ::models::MetaV1Time) {
    self.creation_timestamp = Some(creation_timestamp);
  }

  pub fn with_creation_timestamp(mut self, creation_timestamp: ::models::MetaV1Time) -> MetaV1ObjectMeta {
    self.creation_timestamp = Some(creation_timestamp);
    self
  }

  pub fn creation_timestamp(&self) -> Option<&::models::MetaV1Time> {
  ...
  pub fn with_deletion_grace_period_seconds(mut self, deletion_grace_period_seconds: i64) -> MetaV1ObjectMeta {
    self.deletion_grace_period_seconds = Some(deletion_grace_period_seconds);
    self
  }
  ...
  pub fn set_deletion_timestamp(&mut self, deletion_timestamp: ::models::MetaV1Time) {
    self.deletion_timestamp = Some(deletion_timestamp);
  }

  pub fn with_deletion_timestamp(mut self, deletion_timestamp: ::models::MetaV1Time) -> MetaV1ObjectMeta {
    self.deletion_timestamp = Some(deletion_timestamp);
    self
  }

  pub fn deletion_timestamp(&self) -> Option<&::models::MetaV1Time> {
  ...
  pub fn with_finalizers(mut self, finalizers: Vec<String>) -> MetaV1ObjectMeta {
    self.finalizers = Some(finalizers);
    self
  }
  ...
  pub fn with_generate_name(mut self, generate_name: String) -> MetaV1ObjectMeta {
    self.generate_name = Some(generate_name);
    self
  }
  ...
  pub fn with_generation(mut self, generation: i64) -> MetaV1ObjectMeta {
    self.generation = Some(generation);
    self
  }
  ...
  pub fn set_initializers(&mut self, initializers: ::models::MetaV1Initializers) {
    self.initializers = Some(initializers);
  }

  pub fn with_initializers(mut self, initializers: ::models::MetaV1Initializers) -> MetaV1ObjectMeta {
    self.initializers = Some(initializers);
    self
  }

  pub fn initializers(&self) -> Option<&::models::MetaV1Initializers> {
  ...
  pub fn with_labels(mut self, labels: ::std::collections::HashMap<String, String>) -> MetaV1ObjectMeta {
    self.labels = Some(labels);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> MetaV1ObjectMeta {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_namespace(mut self, namespace: String) -> MetaV1ObjectMeta {
    self.namespace = Some(namespace);
    self
  }
  ...
  pub fn set_owner_references(&mut self, owner_references: Vec<::models::MetaV1OwnerReference>) {
    self.owner_references = Some(owner_references);
  }

  pub fn with_owner_references(mut self, owner_references: Vec<::models::MetaV1OwnerReference>) -> MetaV1ObjectMeta {
    self.owner_references = Some(owner_references);
    self
  }

  pub fn owner_references(&self) -> Option<&Vec<::models::MetaV1OwnerReference>> {
  ...
  pub fn with_resource_version(mut self, resource_version: String) -> MetaV1ObjectMeta {
    self.resource_version = Some(resource_version);
    self
  }
  ...
  pub fn with_self_link(mut self, self_link: String) -> MetaV1ObjectMeta {
    self.self_link = Some(self_link);
    self
  }
  ...
  pub fn with_uid(mut self, uid: String) -> MetaV1ObjectMeta {
    self.uid = Some(uid);
    self
  }
