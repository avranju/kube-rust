...
/// AdmissionregistrationV1alpha1Rule : Rule is a tuple of APIGroups, APIVersion, and Resources.It is recommended to make sure that all the tuple expansions are valid.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct AdmissionregistrationV1alpha1Rule {
...
impl AdmissionregistrationV1alpha1Rule {
  /// Rule is a tuple of APIGroups, APIVersion, and Resources.It is recommended to make sure that all the tuple expansions are valid.
  pub fn new() -> AdmissionregistrationV1alpha1Rule {
  ...
  pub fn with_api_groups(mut self, api_groups: Vec<String>) -> AdmissionregistrationV1alpha1Rule {
    self.api_groups = Some(api_groups);
    self
  }
  ...
  pub fn with_api_versions(mut self, api_versions: Vec<String>) -> AdmissionregistrationV1alpha1Rule {
    self.api_versions = Some(api_versions);
    self
  }
  ...
  pub fn with_resources(mut self, resources: Vec<String>) -> AdmissionregistrationV1alpha1Rule {
    self.resources = Some(resources);
    self
  }
