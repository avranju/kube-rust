...
/// RbacV1beta1PolicyRule : PolicyRule holds information that describes a policy rule, but does not contain information about who the rule applies to or which namespace the rule applies to.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize)]
pub struct RbacV1beta1PolicyRule {
...
impl RbacV1beta1PolicyRule {
  /// PolicyRule holds information that describes a policy rule, but does not contain information about who the rule applies to or which namespace the rule applies to.
  pub fn new(verbs: Vec<String>) -> RbacV1beta1PolicyRule {
  ...
  pub fn with_api_groups(mut self, api_groups: Vec<String>) -> RbacV1beta1PolicyRule {
    self.api_groups = Some(api_groups);
    self
  }
  ...
  pub fn with_non_resource_ur_ls(mut self, non_resource_ur_ls: Vec<String>) -> RbacV1beta1PolicyRule {
    self.non_resource_ur_ls = Some(non_resource_ur_ls);
    self
  }
  ...
  pub fn with_resource_names(mut self, resource_names: Vec<String>) -> RbacV1beta1PolicyRule {
    self.resource_names = Some(resource_names);
    self
  }
  ...
  pub fn with_resources(mut self, resources: Vec<String>) -> RbacV1beta1PolicyRule {
    self.resources = Some(resources);
    self
  }
  ...
  pub fn with_verbs(mut self, verbs: Vec<String>) -> RbacV1beta1PolicyRule {
    self.verbs = verbs;
    self
  }
