...
pub struct AppsV1beta1DeploymentCondition {
...
impl AppsV1beta1DeploymentCondition {
  /// DeploymentCondition describes the state of a deployment at a certain point.
  pub fn new(status: String, _type: String) -> AppsV1beta1DeploymentCondition {
  ...
  pub fn with_last_transition_time(mut self, last_transition_time: ::models::MetaV1Time) -> AppsV1beta1DeploymentCondition {
    self.last_transition_time = Some(last_transition_time);
    self
  }
  ...
  pub fn with_last_update_time(mut self, last_update_time: ::models::MetaV1Time) -> AppsV1beta1DeploymentCondition {
    self.last_update_time = Some(last_update_time);
    self
  }
  ...
  pub fn with_message(mut self, message: String) -> AppsV1beta1DeploymentCondition {
    self.message = Some(message);
    self
  }
  ...
  pub fn with_reason(mut self, reason: String) -> AppsV1beta1DeploymentCondition {
    self.reason = Some(reason);
    self
  }
  ...
  pub fn with_status(mut self, status: String) -> AppsV1beta1DeploymentCondition {
    self.status = status;
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> AppsV1beta1DeploymentCondition {
    self._type = _type;
    self
  }
