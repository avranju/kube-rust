...
pub struct ExtensionsV1beta1IngressRule {
  ...
  host: Option<String>,
  #[serde(rename = "http")]
  http: Option<::models::ExtensionsV1beta1HttpIngressRuleValue>
}
...
impl ExtensionsV1beta1IngressRule {
  ...
  pub fn with_host(mut self, host: String) -> ExtensionsV1beta1IngressRule {
    self.host = Some(host);
    self
  }
  ...
  pub fn set_http(&mut self, http: ::models::ExtensionsV1beta1HttpIngressRuleValue) {
    self.http = Some(http);
  }

  pub fn with_http(mut self, http: ::models::ExtensionsV1beta1HttpIngressRuleValue) -> ExtensionsV1beta1IngressRule {
    self.http = Some(http);
    self
  }

  pub fn http(&self) -> Option<&::models::ExtensionsV1beta1HttpIngressRuleValue> {
    self.http.as_ref()
  }
