...
impl V1SecretProjection {
  ...
  pub fn with_items(mut self, items: Vec<::models::V1KeyToPath>) -> V1SecretProjection {
    self.items = Some(items);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> V1SecretProjection {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_optional(mut self, optional: bool) -> V1SecretProjection {
    self.optional = Some(optional);
    self
  }
