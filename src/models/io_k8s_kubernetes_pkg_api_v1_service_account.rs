...
pub struct V1ServiceAccount {
  ...
  secrets: Option<Vec<::models::V1ObjectReference>>
}
...
impl V1ServiceAccount {
  ...
  pub fn with_api_version(mut self, api_version: String) -> V1ServiceAccount {
    self.api_version = Some(api_version);
    self
  }
  ...
  pub fn with_automount_service_account_token(mut self, automount_service_account_token: bool) -> V1ServiceAccount {
    self.automount_service_account_token = Some(automount_service_account_token);
    self
  }
  ...
  pub fn with_image_pull_secrets(mut self, image_pull_secrets: Vec<::models::V1LocalObjectReference>) -> V1ServiceAccount {
    self.image_pull_secrets = Some(image_pull_secrets);
    self
  }
  ...
  pub fn with_kind(mut self, kind: String) -> V1ServiceAccount {
    self.kind = Some(kind);
    self
  }
  ...
  pub fn with_metadata(mut self, metadata: ::models::MetaV1ObjectMeta) -> V1ServiceAccount {
    self.metadata = Some(metadata);
    self
  }
  ...
  pub fn set_secrets(&mut self, secrets: Vec<::models::V1ObjectReference>) {
    self.secrets = Some(secrets);
  }

  pub fn with_secrets(mut self, secrets: Vec<::models::V1ObjectReference>) -> V1ServiceAccount {
    self.secrets = Some(secrets);
    self
  }

  pub fn secrets(&self) -> Option<&Vec<::models::V1ObjectReference>> {
    self.secrets.as_ref()
  }
