...
pub struct V1StorageOsPersistentVolumeSource {
  ...
  secret_ref: Option<::models::V1ObjectReference>,
...
impl V1StorageOsPersistentVolumeSource {
  ...
  pub fn with_fs_type(mut self, fs_type: String) -> V1StorageOsPersistentVolumeSource {
    self.fs_type = Some(fs_type);
    self
  }
  ...
  pub fn with_read_only(mut self, read_only: bool) -> V1StorageOsPersistentVolumeSource {
    self.read_only = Some(read_only);
    self
  }
  ...
  pub fn set_secret_ref(&mut self, secret_ref: ::models::V1ObjectReference) {
    self.secret_ref = Some(secret_ref);
  }

  pub fn with_secret_ref(mut self, secret_ref: ::models::V1ObjectReference) -> V1StorageOsPersistentVolumeSource {
    self.secret_ref = Some(secret_ref);
    self
  }

  pub fn secret_ref(&self) -> Option<&::models::V1ObjectReference> {
  ...
  pub fn with_volume_name(mut self, volume_name: String) -> V1StorageOsPersistentVolumeSource {
    self.volume_name = Some(volume_name);
    self
  }
  ...
  pub fn with_volume_namespace(mut self, volume_namespace: String) -> V1StorageOsPersistentVolumeSource {
    self.volume_namespace = Some(volume_namespace);
    self
  }
