...
/// ExtensionsV1beta1DaemonSetStatus : DaemonSetStatus represents the current status of a daemon set.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct ExtensionsV1beta1DaemonSetStatus {
...
impl ExtensionsV1beta1DaemonSetStatus {
  /// DaemonSetStatus represents the current status of a daemon set.
  pub fn new(current_number_scheduled: i32, desired_number_scheduled: i32, number_misscheduled: i32, number_ready: i32) -> ExtensionsV1beta1DaemonSetStatus {
  ...
  pub fn with_collision_count(mut self, collision_count: i64) -> ExtensionsV1beta1DaemonSetStatus {
    self.collision_count = Some(collision_count);
    self
  }
  ...
  pub fn with_current_number_scheduled(mut self, current_number_scheduled: i32) -> ExtensionsV1beta1DaemonSetStatus {
    self.current_number_scheduled = current_number_scheduled;
    self
  }
  ...
  pub fn with_desired_number_scheduled(mut self, desired_number_scheduled: i32) -> ExtensionsV1beta1DaemonSetStatus {
    self.desired_number_scheduled = desired_number_scheduled;
    self
  }
  ...
  pub fn with_number_available(mut self, number_available: i32) -> ExtensionsV1beta1DaemonSetStatus {
    self.number_available = Some(number_available);
    self
  }
  ...
  pub fn with_number_misscheduled(mut self, number_misscheduled: i32) -> ExtensionsV1beta1DaemonSetStatus {
    self.number_misscheduled = number_misscheduled;
    self
  }
  ...
  pub fn with_number_ready(mut self, number_ready: i32) -> ExtensionsV1beta1DaemonSetStatus {
    self.number_ready = number_ready;
    self
  }
  ...
  pub fn with_number_unavailable(mut self, number_unavailable: i32) -> ExtensionsV1beta1DaemonSetStatus {
    self.number_unavailable = Some(number_unavailable);
    self
  }
  ...
  pub fn with_observed_generation(mut self, observed_generation: i64) -> ExtensionsV1beta1DaemonSetStatus {
    self.observed_generation = Some(observed_generation);
    self
  }
  ...
  pub fn with_updated_number_scheduled(mut self, updated_number_scheduled: i32) -> ExtensionsV1beta1DaemonSetStatus {
    self.updated_number_scheduled = Some(updated_number_scheduled);
    self
  }
