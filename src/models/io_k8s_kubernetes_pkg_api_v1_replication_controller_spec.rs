...
impl V1ReplicationControllerSpec {
  ...
  pub fn with_min_ready_seconds(mut self, min_ready_seconds: i32) -> V1ReplicationControllerSpec {
    self.min_ready_seconds = Some(min_ready_seconds);
    self
  }
  ...
  pub fn with_replicas(mut self, replicas: i32) -> V1ReplicationControllerSpec {
    self.replicas = Some(replicas);
    self
  }
  ...
  pub fn with_selector(mut self, selector: ::std::collections::HashMap<String, String>) -> V1ReplicationControllerSpec {
    self.selector = Some(selector);
    self
  }
  ...
  pub fn with_template(mut self, template: ::models::V1PodTemplateSpec) -> V1ReplicationControllerSpec {
    self.template = Some(template);
    self
  }
