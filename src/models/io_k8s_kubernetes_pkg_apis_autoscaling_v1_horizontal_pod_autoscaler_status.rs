...
/// AutoscalingV1HorizontalPodAutoscalerStatus : current status of a horizontal pod autoscaler

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct AutoscalingV1HorizontalPodAutoscalerStatus {
...
impl AutoscalingV1HorizontalPodAutoscalerStatus {
  /// current status of a horizontal pod autoscaler
  pub fn new(current_replicas: i32, desired_replicas: i32) -> AutoscalingV1HorizontalPodAutoscalerStatus {
  ...
  pub fn with_current_cpu_utilization_percentage(mut self, current_cpu_utilization_percentage: i32) -> AutoscalingV1HorizontalPodAutoscalerStatus {
    self.current_cpu_utilization_percentage = Some(current_cpu_utilization_percentage);
    self
  }
  ...
  pub fn with_current_replicas(mut self, current_replicas: i32) -> AutoscalingV1HorizontalPodAutoscalerStatus {
    self.current_replicas = current_replicas;
    self
  }
  ...
  pub fn with_desired_replicas(mut self, desired_replicas: i32) -> AutoscalingV1HorizontalPodAutoscalerStatus {
    self.desired_replicas = desired_replicas;
    self
  }
  ...
  pub fn with_last_scale_time(mut self, last_scale_time: ::models::MetaV1Time) -> AutoscalingV1HorizontalPodAutoscalerStatus {
    self.last_scale_time = Some(last_scale_time);
    self
  }
  ...
  pub fn with_observed_generation(mut self, observed_generation: i64) -> AutoscalingV1HorizontalPodAutoscalerStatus {
    self.observed_generation = Some(observed_generation);
    self
  }
