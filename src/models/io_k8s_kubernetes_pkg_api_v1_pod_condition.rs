...
impl V1PodCondition {
  ...
  pub fn with_last_probe_time(mut self, last_probe_time: ::models::MetaV1Time) -> V1PodCondition {
    self.last_probe_time = Some(last_probe_time);
    self
  }
  ...
  pub fn with_last_transition_time(mut self, last_transition_time: ::models::MetaV1Time) -> V1PodCondition {
    self.last_transition_time = Some(last_transition_time);
    self
  }
