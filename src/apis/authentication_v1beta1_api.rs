...
pub trait AuthenticationV1beta1Api {
    fn create_authentication_v1beta1_token_review(&self, body: ::models::AuthenticationV1beta1TokenReview, pretty: &str) -> Box<Future<Item = ::models::AuthenticationV1beta1TokenReview, Error = Error>>;
    fn get_authentication_v1beta1_api_resources(&self, ) -> Box<Future<Item = ::models::MetaV1ApiResourceList, Error = Error>>;
}
...
impl<C: hyper::client::Connect>AuthenticationV1beta1Api for AuthenticationV1beta1ApiClient<C> {
    fn create_authentication_v1beta1_token_review(&self, body: ::models::AuthenticationV1beta1TokenReview, pretty: &str) -> Box<Future<Item = ::models::AuthenticationV1beta1TokenReview, Error = Error>> {
        ...
        Box::new(
            ...
            .and_then(|body| {
                let parsed: Result<::models::AuthenticationV1beta1TokenReview, _> = serde_json::from_slice(&body);
